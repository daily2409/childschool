                        ...
                        <div class="card-body">
                            <form action="{{ route('system.news.postAddNews') }}" method="post"  enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                    <textarea id="content" class="summernote-editor" name="content">{!!old('content')!!}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Summary Content</label>
                                    <div class="col-sm-10">
                                    <textarea id="summaryContent" name="summary_content" rows="10" cols="50">{!!old('summary_content')!!}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-10">
