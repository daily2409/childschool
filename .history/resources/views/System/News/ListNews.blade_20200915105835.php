                        ...
                        <div class="card-body">
                            <form action="" method="get"  enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Title</label>
                                    <div class="col-sm-10">
                                        <input name="name_search" value="{{request()->input('name_search')}}" class="form-control" type="text" id="title">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Id</label>
                                    <div class="col-sm-10">
                                        <input name="id_search" value="{{request()->input('id_search')}}" class="form-control" type="text" id="id">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-10">
