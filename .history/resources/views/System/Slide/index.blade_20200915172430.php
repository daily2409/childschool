...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="la->id" data-toggle="tab" href="#add-new" role="tab" aria-controls="home" aria-selected="true">ADD BLOG</a>
        </li>
    </ul>
                        ...
                        <div class="card-body">
                            <form method="post"  enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="name" value="{!!old('name')!!}" class="form-control" type="text" id="title" require>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        {{-- <textarea class="summernote-editor" name="content" id="textcontent"></textarea> --}}
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-10">
                                        <button id="btn-save" type="submit" class="btn btn-info waves-effect waves-light">
                                            Save
                                        </button>
                                        <button id="btn-cancel" type="reset" class="btn btn-danger waves-effect m-l-5">
                                            Cancel
                                        </button>
                                    </div>
                                </div>
                        ...
                        <table class="table" id="my-table">
                            ...
                            <tbody>
                                ...
                                <tr id="id_{{$item->id }}">
                                    ...
                                    <td><span class="tabledit-span tabledit-identifier">{{ $item->link_image }}</span></td>
                                    <td><span class="tabledit-span tabledit-identifier">{{ $item->url }}</span></td>

                                    {{-- <td class="tabledit-view-mode"><span class="tabledit-span"><img src="{{ $item->Image }}" height="50" width="100" alt=""></span></td> --}}
                                    <td><span class="tabledit-span tabledit-identifier">{{ $item->order }}</span></td>
                                    <td class="tabledit-view-mode"><span class="tabledit-span tabledit-identifier">{{ $item->status }}</span></td>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.33.1/sweetalert2.min.js?v={{time()}}"></script>
<script>
    ...
    $('#btn-save').click(function(e){
        ...
        $.ajax({
                method: "POST",
                url: '{{route("system.blog.postAddBlog")}}',
                data: {_token: token, 'title': title, 'description': description, 'link': link},
                success: function (result) {
