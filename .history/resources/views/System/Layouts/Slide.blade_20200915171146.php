<div class="sidebar-inner slimscrollleft" id="sidebar-main">
    ...
    <div id="sidebar-menu">
        <ul>
            ...
            <li class="">
                <a href="{{ route('system.blog.getListSlide') }}" class="waves-effect waves-light"><i class="fa fa-user"></i><span> BLOGS </span></a>
            </li>
            <li class="">
                <a href="{{ route('system.slide.getListSlide') }}" class="waves-effect waves-light"><i class="fa fa-user"></i><span> SLIDE </span></a>
            </li>
            <li class="">
