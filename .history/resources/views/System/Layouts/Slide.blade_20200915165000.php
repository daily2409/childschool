<div class="sidebar-inner slimscrollleft" id="sidebar-main">
    ...
    <div id="sidebar-menu">
        <ul>
            ...
            <li class="">
                <a href="{{ route('system.blog.getListBlog') }}" class="waves-effect waves-light"><i class="fa fa-user"></i><span> BLOGS </span></a>
            </li>
            <li class="">
                <a href="{{ route('system.background.getListBlog') }}" class="waves-effect waves-light"><i class="fa fa-user"></i><span> BACKGROUND </span></a>
            </li>
            <li class="">
