                        ...
                        <div class="card-body">
                            <form action="{{ route('system.news.postAddNews') }}" method="post"  enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="" id="textcontent"  class="form-control" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="" id="textsummaryContent"  class="form-control" >
                                    {{-- <textarea name="summary_content" rows="10" cols="50" id="textsummaryContent">{!!old('summary_content')!!}</textarea> --}}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-10">
...
<script>
    ...
    $('#btn-save').click(function(e){
        ...
        summaryContent = $('#textsummaryContent').val()
        $.ajax({
                method: "POST",
                url: '{{route("system.blog.postAddBlog")}}',
                data: {_token: token, 'title': title, 'content': content, 'summary_content': summaryContent},
                success: function (result) {
