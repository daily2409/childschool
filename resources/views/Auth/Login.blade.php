            ...
            <div class="card">
                <div class="card-body">
                    <h3 class="text-center mt-0">
                        <a href="index.html" class="logo logo-admin"><img src="landing/images/logo/kidlogo.png" alt="" width="220" height="73" class="scalable shadowLogo" title=""/>
                             Administrator
                        </a>
