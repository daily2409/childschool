...
<head>
    ...
    <link rel="shortcut icon" href="https://www.smartkidsinfo.com/favicon.ico" >
    <meta name="SKYPE_TOOLBAR" content="SKYPE_TOOLBAR_PARSER_COMPATIBLE" />

	<!-- Standard Favicon -->
	<link rel="icon" type="image/x-icon" href="landing/images/logo/kidlogo.png" />
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="landing/images/logo/kidlogo.png">
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="landing/images/logo/kidlogo.png">
	<link rel="apple-touch-icon-precomposed" href="landing/images/logo/kidlogo.png">
